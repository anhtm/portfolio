<template>
	<div>
		<!-- About -->
    <section class="section is-medium" id="section-about">
      <div class="container" id="about">
        <div class="columns">
          ...
          <div class="column is-offset-1 is-4 is-hidden-touch">
            <figure class="image">
              <img id="ava" class="img-thumbnail" src="http://i.imgur.com/uNs81id.jpg" alt="avatar">  
            </figure>
          </div>
